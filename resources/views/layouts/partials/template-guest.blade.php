...
<body class="horizontal-layout page-header-light horizontal-menu preload-transitions 2-columns   " data-open="click"
    data-menu="horizontal-menu" data-col="2-columns" translate="no">
    <div id="app">
        <!-- BEGIN: Header-->
                        ...
                        <ul class="left">
                            <li>
                                <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="/"><img
                                            src="app-assets/images/logo/materialize-logo.png" alt="materialize logo"><span
                                            class="logo-text hide-on-med-and-down">Pandero</span></a></h1>
                            </li>
                        </ul>
                        <ul class="navbar-list right">
                            <li>
                                <a class="mb-6 btn waves-effect waves-light purple lightrn-1"
                                    href="/login">
                                    ...
                                    <div class="card recent-buyers-card animate fadeUp">
                                        <div class="card-content">
                                            ...
                                            <ul class="collection mb-0">
                                                ...
                                                <li class="collection-item avatar">
                                                    <img src="app-assets/images/avatar/avatar-3.png" alt=""
                                                        class="circle" />
                                ...
                                <div class="col s12 m6 l4">
                                    ...
                                    <div id="chartjs" class="card pt-0 pb-0 animate fadeLeft">
                                        <div class="dashboard-revenue-wrapper padding-2 ml-2">
                                            <span
                                                class="new badge gradient-45deg-indigo-purple gradient-shadow mt-2 mr-2">+
                                                $900</span>
