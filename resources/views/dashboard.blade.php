        ...
        <div class="row">
            <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="#">Dashboards</a>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col s12 m4 l4">
                    <div class="card pt-0 pb-0 animate fadeRight">
                        <div class="dashboard-revenue-wrapper padding-2 ml-2">
                            <span
                                class="new badge gradient-45deg-amber-amber gradient-shadow mt-2 mr-2">+
                                $900</span>
                        ...
                        <div class="sample-chart-wrapper"
                            style="margin-bottom: -14px; margin-top: -75px;">
                            <canvas id="custom-line-chart-sample-three"
                                class="center"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col s12 m4">
                    <div class="card animate fadeUp">
                        ...
                        <div class="card-action pt-0">
                            ...
                            <div class="chip">192kb <i
                                    class="close material-icons">close</i></div>
                            <div class="chip">320kb <i
                                    class="close material-icons">close</i></div>
                        </div>
                        <div class="card-action pt-0">
                        ...
                        <div
                            ...
                            <div class="card-content center">
                                <img src="app-assets/images/icon/apple-watch.png"
                                    class="width-40 border-round z-depth-5 responsive-img"
                                    alt="image" />
